...
## News
- 07/05/2023: Implementation of [time prioritized SDS](https://arxiv.org/abs/2306.12422)! Follow the instructions [here](https://github.com/threestudio-project/threestudio#tips-on-improving-quality) to give it a try.
...
- **Try TP-SDS.** The [TP-SDS algorithm](https://arxiv.org/pdf/2306.12422) can potentially alleviate the multi-face Janus problem and improve sample diversity. You can enable TP-SDS by setting `system.guidance.time_prior=[800,500,300,100]`, where the order is `[m1,m2,s1,s2]`, and the values are suggested by the original paper. These values work well for SDS. For VSD these value might need to be tuned.
