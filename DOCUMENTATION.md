...
| time_prior                        | Optional[Any] | The time prior values. If specified, should be in the form of [m1,m2,s1,s2] as indicated in [TP-SDS](https://arxiv.org/pdf/2306.12422.pdf). You need to feed in current_step_ratio when calling guidance when using this. Default: None                 |
