...
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 2 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya18_batch_size=10;fovy_range=[20.0,35.0]" data.random_camera.progressive_until=500
