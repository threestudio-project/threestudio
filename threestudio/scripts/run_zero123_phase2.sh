...
# PHASE 2
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 0 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya35_max_steps=10000;max_step_percent=0.3;progressive_until=0" data.random_camera.progressive_until=0
