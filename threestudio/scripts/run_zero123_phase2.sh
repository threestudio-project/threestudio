...
# PHASE 2
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 4 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya31_max_steps=10000_progressive_until=0;ambient_ratio=0.7+0.3*rand" data.random_camera.progressive_until=0
