...
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 5 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya12_ambient_ratio=0.2+0.8*random" data.random_camera.progressive_until=500
