...
# PHASE 2
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 3 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya30_max_steps=10000_progressive_until=0" data.random_camera.progressive_until=0
