...
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 1 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya24_ambient_ratio=0.5+0.5*random" data.random_camera.progressive_until=500
