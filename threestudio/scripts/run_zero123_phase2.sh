...
# PHASE 2
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 7 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya34_max_steps=10000;max_step_percent=0.8;progressive_until=0" data.random_camera.progressive_until=0
