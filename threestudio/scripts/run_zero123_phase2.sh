...
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 2 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya17_camera_distance_range=[1.6, 2.0]" data.random_camera.progressive_until=500
