...
# PHASE 2
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 1 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya24_camera_distance_range:[2.4,3.0]" data.random_camera.progressive_until=500
