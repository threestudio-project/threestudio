...
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 7 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya13_ambient_ratio=0.3+0.7*random" data.random_camera.progressive_until=500
