...
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 4 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya19_min_max_step_percent=[0.02,0.25]" data.random_camera.progressive_until=500
