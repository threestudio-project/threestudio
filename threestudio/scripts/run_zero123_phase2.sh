...
# PHASE 2
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 5 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya32_max_steps=10000_ambient_only_steps:5000;progressive_until=5000" data.random_camera.progressive_until=5000
