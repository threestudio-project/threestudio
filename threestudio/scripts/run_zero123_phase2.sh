...
python launch.py --config configs/experimental/imagecondition_zero123nerf.yaml --train --gpu 6 \
  ...
  data.image_path=./load/images/anya_front_rgba.png system.loggers.wandb.name="anya33_max_steps=10000;lambda_sparsity=0.001;ambient_only_steps:5000;progressive_until=5000" data.random_camera.progressive_until=5000
