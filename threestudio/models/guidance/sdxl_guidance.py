...
@threestudio.register("sdxl-guidance")
class SDXLGuidance(BaseObject):
    @dataclass
    ...
    def configure(self) -> None:
        threestudio.info(f"Loading SDXL ...")
        ...
        pipe_kwargs = {
            ...
            "variant": "fp16" if self.weights_dtype == torch.float16 else "fp32",
