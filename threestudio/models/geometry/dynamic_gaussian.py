...
from threestudio.models.geometry.gaussian import GaussianModel, BasicPointCloud
...
class DynamicGaussianModel(BaseGeometry):
    ...
    def configure(self) -> None:
        super().configure()
        self.gaussian = threestudio.find("gaussian")(
            self.cfg.gaussian
        )
        self.dynamic_geo = threestudio.find(self.cfg.dynamic_geo_name)(self.cfg.dynamic_geo)
    ...
    def get_covariance(self, scaling_modifier = 1):
        return self.gaussian.covariance_activation(self.gaussian.get_scaling, scaling_modifier, self.gaussian._rotation)
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation):
        self.gaussian.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation)
    ...
    def update_states(
        ...
        self.gaussian.update_states(iteration, visibility_filter, radii, viewspace_point_tensor, extent)