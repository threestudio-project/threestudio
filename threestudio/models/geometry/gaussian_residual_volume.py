...
@threestudio.register("gaussian-residual-volume")
class GaussianResidualModel(BaseGeometry):
    ...
    def configure(self) -> None:
        ...
        self.xyz_residual_network = get_mlp(
            self.encoding.n_output_dims, 3, self.cfg.mlp_network_config
        )
        self.scaling_residual_network = get_mlp(
            self.encoding.n_output_dims, 3, self.cfg.mlp_network_config
        )
        ...
        l = [
            {
                ...
                + list(self.xyz_residual_network.parameters()),
                "lr": training_args.xyz_residual_lr,
                "name": "xyz_residual",
            },
            {
            ...
            {
                "params": list(self.scaling_residual_network.parameters()),
