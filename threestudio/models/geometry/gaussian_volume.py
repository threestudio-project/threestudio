...
@threestudio.register("gaussian-volume")
class GaussianVolumeModel(BaseGeometry):
    @dataclass
    ...
    def get_opacity(self):
        ...
        density = self.density_network(enc).view(*self._xyz.shape[:-1], 1)
        return self.opacity_activation(density)
    ...
    def training_setup(self):
        ...
        l = [
            ...
            # },
            {
                ...
                + list(self.density_network.parameters()),
                "lr": training_args.opacity_lr,
                "name": "opacity_network",
            },
            {
