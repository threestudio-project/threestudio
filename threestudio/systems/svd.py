...
@threestudio.register("svd-system")
class StableVideoDiffusion(BaseLift3DSystem):
    @dataclass
    ...
    def training_substep(self, batch, batch_idx, guidance: str):
        """
        Args:
            guidance: one of "ref" (reference image supervision), "svd"
        """
        if guidance == "ref":
    ...
    def training_step(self, batch, batch_idx):
        ...
        # SGM SVD
        out = self.training_substep(batch, batch_idx, guidance="svd")
        total_loss += out["loss"]
